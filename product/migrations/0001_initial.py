    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('name', models.CharField(max_length=30, verbose_name='Name color')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('name', models.CharField(max_length=30, verbose_name='Model name')),
                ('product_type', models.CharField(choices=[('ladies', 'Ladies'), ('mens', 'Mens'), ('accessories', 'Accessories'), ('dance_shoes', 'Dance shoes')], max_length=30, verbose_name='Product type')),
                ('ladies_type', models.CharField(blank=True, choices=[('body', 'Body'), ('blouses', 'Blouses'), ('skirts', 'Skirts'), ('dresses', 'Dresses'), ('trousers', 'Trousers'), ('jumpsuits', 'Jumpsuits'), ('tops', 'Tops'), ('shorts', 'Shorts')], max_length=30, null=True, verbose_name='Ladies type')),
                ('mens_type', models.CharField(blank=True, choices=[('trousers', 'Trousers'), ('waistcoasts', 'Waistcoasts'), ('shirts', 'Shirts'), ('t_shirts', 'T-shirts')], max_length=30, null=True, verbose_name='Mens type')),
                ('accessories_type', models.CharField(blank=True, choices=[('shoe_accessories', 'Shoe accessories'), ('bags', 'Bags'), ('ladies_accessories', 'Ladies accessories'), ('t_shirts', 'T-shirts')], max_length=30, null=True, verbose_name='Accessories type')),
                ('dance_shoes_type', models.CharField(blank=True, choices=[('ladies', 'Ladies'), ('mens', 'Mens')], max_length=30, null=True, verbose_name='Dance shoes type')),
                ('article', models.CharField(max_length=30, verbose_name='Article')),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=0, default_currency='AED', max_digits=9, verbose_name='Price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата обновления')),
                ('basket', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='product.Basket', verbose_name='Basket')),
